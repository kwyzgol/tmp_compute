...
def _save_model(agent: ReinforceAgent, e_name: str, steps: int) -> str:
...
def _evaluate(
    ...
    env: GameEnv,
    agent: ReinforceAgent,
    previous_agent: ReinforceAgent | None,
...
def train_reinforce(
    ...
    logger = TrainingLogger(
        ...
        settings=settings,
        algo_name=AlgoName.REINFORCE,
        algo_type=AlgoType.POLICY_GRADIENT,
    )

    previous_agent: ReinforceAgent | None = None
