...
from src.agents.per_dqn_agent import PerDqnAgent
...
def _save_model(agent: PerDqnAgent, e_name: str, steps: int) -> str:
...
def _evaluate(
    ...
    env: GameEnv,
    agent: PerDqnAgent,
    previous_agent: PerDqnAgent | None,
...
def train_per_dqn(
    ...
    logger = TrainingLogger(
        ...
        settings=settings,
        algo_name=AlgoName.PER_DQN,
        algo_type=AlgoType.Q_VALUE,
    )

    previous_agent: PerDqnAgent | None = None
