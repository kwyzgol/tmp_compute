...
from src.agents.nstep_dqn_agent import NStepDqnAgent
...
def _save_model(agent: NStepDqnAgent, e_name: str, steps: int) -> str:
...
def _evaluate(
    ...
    env: GameEnv,
    agent: NStepDqnAgent,
    previous_agent: NStepDqnAgent | None,
...
def train_nstep_dqn(
    ...
    logger = TrainingLogger(
        ...
        settings=settings,
        algo_name=AlgoName.N_STEP_DQN,
        algo_type=AlgoType.Q_VALUE,
    )

    previous_agent: NStepDqnAgent | None = None
