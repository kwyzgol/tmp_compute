...
from src.agents.noisy_dqn_agent import NoisyDqnAgent
...
def _save_model(agent: NoisyDqnAgent, e_name: str, steps: int) -> str:
...
def _evaluate(
    ...
    env: GameEnv,
    agent: NoisyDqnAgent,
    previous_agent: NoisyDqnAgent | None,
...
def train_noisy_dqn(
    ...
    logger = TrainingLogger(
        ...
        settings=settings,
        algo_name=AlgoName.NOISY_DQN,
        algo_type=AlgoType.Q_VALUE,
    )

    previous_agent: NoisyDqnAgent | None = None
