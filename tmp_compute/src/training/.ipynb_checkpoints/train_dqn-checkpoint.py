...
def _save_model(agent: DqnAgent, e_name: str, steps: int) -> str:
...
def train_dqn(
    ...
    training_steps = 0
    next_eval_step = settings.eval_after
    ...
    while training_steps < settings.total_max_training_steps:
        ...
        if training_steps >= next_eval_step:
            ...
            next_eval_step = training_steps + settings.eval_after
