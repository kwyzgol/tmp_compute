...
def _save_model(agent: DoubleDqnAgent, e_name: str, steps: int) -> str:
...
def _evaluate(
    ...
    env: GameEnv,
    agent: DoubleDqnAgent,
    previous_agent: DoubleDqnAgent | None,
...
def train_double_dqn(
    ...
    logger = TrainingLogger(
        ...
        settings=settings,
        algo_name=AlgoName.DOUBLE_DQN,
        algo_type=AlgoType.Q_VALUE,
    )

    previous_agent: DoubleDqnAgent | None = None
